...
@Component({
  selector: 'cancelinvreport',
  templateUrl: './cancelinvreport.component.html',
  styleUrls: ['./cancelinvreport.component.scss'],
})
...
export class CancelInvoiceComponent implements OnInit {
  ...
  async download() {
    ...
    if (res) {
      ...
      JSXLSX.writeFile(wb, 'Cancel Invoice Report' + EXCEL_EXTENSION);
    }
  }
